...
class ESSBActivationManager {
	...
	private static $api = "http://api.socialsharingplugin.com/"; //"http://localhost:8081/work/activation/";
	...
	private static $activate_url = "http://activation.socialsharingplugin.com/";
