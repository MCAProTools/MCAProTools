...
<tr valign="top">
		<th scope="row"><label for="lightbox"><?php _e('Post by users filter','userpro'); ?></label></th>
		<td>
			<select name="show_fillter" id="show_fillter" class="chosen-select" style="width:300px">
	...
	<tr valign="top">
		...
		<td>
         <input type="text" name="linkedin_app_key" id="linkedin_app_key" value="<?php echo userpro_get_option('linkedin_app_key'); ?>" class="regular-text" />
			<span class="description"><?php _e('Open <a href="https://developer.linkedin.com/documents/getting-started-javascript-api">https://developer.linkedin.com/documents/getting-started-javascript-api</a> create a new app and edit its settings to make it work on your domain. In App Settings, please paste the App ID or API Key into this field.','userpro'); ?></span>
