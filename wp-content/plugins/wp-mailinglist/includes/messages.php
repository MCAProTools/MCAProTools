...
$messages[7] = __('Newsletters database update done', 'wp-mailinglist');
...
$messages[19] = __('Subscribers are currently importing in the background. You will receive an email notification when it is completed. %s', 'wp-mailinglist');
