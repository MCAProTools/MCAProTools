...
<div class="wrap newsletters <?php echo $this -> pre; ?>">
	...
	<?php if (!empty($subscribers)) : ?>
		<p><?php echo sprintf(__('You are about to export <b>%d</b> subscribers from <b>%d</b> mailing lists with <b>%s</b> status.', 'wp-mailinglist'), count($subscribers), count($_POST['export_lists']), $_POST['export_status']); ?></p>
