...
<?php /*<h2 class="nav-tab-wrapper">
	<a class="nav-tab <?php echo ($_GET['page'] == $this -> sections -> extensions) ? 'nav-tab-active' : ''; ?>" href="?page=<?php echo $this -> sections -> extensions; ?>"><?php _e('Manage', 'wp-mailinglist'); ?></a>
	<a class="nav-tab <?php echo ($_GET['page'] == $this -> sections -> extensions_settings) ? 'nav-tab-active' : ''; ?>" href="?page=<?php echo $this -> sections -> extensions_settings; ?>"><?php _e('Settings', 'wp-mailinglist'); ?></a>
</h2>*/ ?>
