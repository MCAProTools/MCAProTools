<div class="wrap newsletters">
	...
	<p>
		<a href="<?php echo admin_url('widgets.php'); ?>" class="button"><?php _e('Go to Widgets', 'wp-mailinglist'); ?></a>
		<a href="<?php echo admin_url('widgets.php?editwidget=newsletters&addnew=1&num=1&base=newsletters'); ?>" class="button button-primary"><?php _e('Add Widget', 'wp-mailinglist'); ?></a>
	</p>
	...
	<textarea onclick="this.select();" class="widefat" cols="100%" rows="10" style="width:100%;"><?php echo htmlentities(stripslashes($output)); ?></textarea>
</div>