...
<table class="form-table">
	<tbody>
		<tr>
			<th><label for="etsubject_confirm"><?php _e('Email Subject', 'wp-mailinglist'); ?></label></th>
			<td>
				    	...
				    	<div id="languagetabsconfirm">
				            ...
				            <?php foreach ($languages as $language) : ?>
				            	<div id="languagetabconfirm<?php echo $tabnumber; ?>">
				            		<input type="text" name="etsubject_confirm[<?php echo $language; ?>]" value="<?php echo esc_attr(stripslashes($this -> language_use($language, $etsubject_confirm))); ?>" id="etsubject_confirm_<?php echo $language; ?>" class="widefat" />
				            	</div>
				            	<?php $tabnumber++; ?>
				            <?php endforeach; ?>
				    	</div>
		...
		<tr>
			<th><label for="etmessage_confirm"><?php _e('Email Message', 'wp-mailinglist'); ?></label></th>
			<td>
				<?php if ($this -> language_do()) : ?>
					<?php if (!empty($languages) && is_array($languages)) : ?>
				    	<div id="languagetabsconfirmmessage">
				            ...
				            <?php foreach ($languages as $language) : ?>
				            	<div id="languagetabconfirmmessage<?php echo $tabnumber; ?>">
									...
									wp_editor(stripslashes($this -> language_use($language, $etmessage_confirm)), 'etmessage_confirm_' . $language, $settings); 
