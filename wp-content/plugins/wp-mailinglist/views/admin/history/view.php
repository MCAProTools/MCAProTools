...
$todate = (empty($_GET['to'])) ? $Html -> gen_date("Y-m-d") : $_GET['to'];
	            ...
	            <?php if (!empty($history -> post_id)) : ?>
	            	...
	            	<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
		            	...
		            	<td>
			            	...
			            	<a class="" href="<?php echo admin_url('admin.php?page=' . $this -> sections -> history . '&method=unlinkpost&id=' . $history -> id); ?>" onclick="if (!confirm('<?php _e('Are you sure you want to unlink this post from this newsletter?', 'wp-mailinglist'); ?>')) { return false; }"><i class="fa fa-chain-broken"></i></a>
		            	</td>
	            	</tr>
	            <?php endif; ?>
	            <tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
