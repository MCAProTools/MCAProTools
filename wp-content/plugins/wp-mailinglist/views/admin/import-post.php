<div class="wrap newsletters <?php echo $this -> pre; ?>">
	...
	<?php if (!empty($subscribers)) : ?>		
		...
		<p class="submit">
			...
			<a href="" onclick="cancelimporting(); return false;" id="cancelimporting" disabled="disabled" style="display:none;" class="button-secondary"><i class="fa fa-pause"></i> <?php _e('Pause', 'wp-mailinglist'); ?></a>
			<a href="" onclick="startimporting(); return false;" id="startimporting" disabled="disabled" class="button-primary"><i class="fa fa-refresh fa-spin"></i> <?php _e('Reading data, please wait', 'wp-mailinglist'); ?></a>
			<span id="import_loading" style="display:none;"><i class="fa fa-refresh fa-spin fa-fw"></i></span>
			<span id="importmore" style="display:none;"><a href="?page=<?php echo $this -> sections -> importexport; ?>" id="" class="button-secondary"><?php _e('Import More', 'wp-mailinglist'); ?></a></span>
		</p>
		...
		<h3 style="display:none;"><?php _e('Subscribers Imported', 'wp-mailinglist'); ?></h3>
		<div id="importajaxsuccessrecords" class="scroll-list" style="display:none;"><!-- successful records --></div>
		
		<h3 style="display:none;"><?php _e('Failed Subscribers', 'wp-mailinglist'); ?></h3>
	...
	<?php else : ?>
		<p class="newsletters_error"><?php _e('No subscribers are available for import, please try again.', 'wp-mailinglist'); ?></p>
		<p>
