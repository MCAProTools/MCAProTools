...
<div class="wrap newsletters about-wrap">
	...
	<div class="changelog newsletters-changelog">
		...
		<p>
			...
			<p><?php _e('or', 'wp-mailinglist'); ?> <a href="<?php echo admin_url('admin.php?page=' . $this -> sections -> submitserial); ?>" onclick="jQuery.colorbox({href:newsletters_ajaxurl + 'action=<?php echo $this -> pre; ?>serialkey'}); return false;"><?php _e('submit a serial key', 'wp-mailinglist'); ?></a></p>
		</p>
	</div>
	...
	<div class="changelog newsletters-changelog">
		<div class="feature-section three-col">
			...
			<div class="col last-feature">
				...
				<p><a class="button button-secondary" href="<?php echo admin_url('admin.php?page=' . $this -> sections -> submitserial); ?>" onclick="jQuery.colorbox({href:newsletters_ajaxurl + 'action=<?php echo $this -> pre; ?>serialkey'}); return false;"><?php _e('Submit Serial', 'wp-mailinglist'); ?></a></p>
			</div>
		</div>
	</div>
