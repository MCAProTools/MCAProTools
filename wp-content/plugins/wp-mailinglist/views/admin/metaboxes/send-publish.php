		...
		<?php if (!empty($_POST['post_id'])) : ?>
			...
			<tr>
				...
				<td>
					...
					<a class="" href="<?php echo admin_url('admin.php?page=' . $this -> sections -> history . '&method=unlinkpost&id=' . $_POST['ishistory']); ?>" onclick="if (!confirm('<?php _e('Are you sure you want to unlink this post from this newsletter?', 'wp-mailinglist'); ?>')) { return false; }"><i class="fa fa-chain-broken"></i></a>
				</td>
			</tr>
		<?php endif; ?>
	</tbody>
