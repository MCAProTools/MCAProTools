...
<div id="bouncemethod_cgi_div" style="display:<?php echo ($bouncemethod == "cgi") ? 'block' : 'none'; ?>;">
	<table class="form-table">
		<tbody>
			<tr>
...
<div id="bouncemethod_pop_div" style="display:<?php echo ($bouncemethod == "pop") ? 'block' : 'none'; ?>;">
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input class="widefat" style="width:65px;" type="text" name="bouncepop_port" value="<?php echo esc_attr(stripslashes($this -> get_option('bouncepop_port'))); ?>" id="bouncepop_port" />
