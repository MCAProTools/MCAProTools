...
<table class="form-table">
	<tbody>
			...
			<td>
				<select onchange="totalemails_calculate();" class="widefat" style="width:auto;" id="scheduleinterval" name="scheduleinterval">
                    ...
                    <?php if (!empty($schedules)) : ?>
                        ...
                        <option data-interval="<?php echo esc_attr(stripslashes($val['interval'])); ?>" <?php echo $sel; ?> value="<?php echo $key ?>"><?php echo $val['display']; ?> (<?php echo $val['interval'] ?> <?php _e('seconds', 'wp-mailinglist'); ?>)</option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
		...
		<tr>
			...
			<td>
				<input onkeyup="totalemails_calculate();" class="widefat" style="width:45px;" type="text" value="<?php echo esc_attr(stripslashes($emailsperinterval)); ?>" id="emailsperinterval" name="emailsperinterval" />
