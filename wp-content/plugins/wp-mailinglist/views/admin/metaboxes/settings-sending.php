...
<table class="form-table">
	<tbody>
        ...
        <tr class="advanced-setting">
	        ...
	        <td>
		        <label><input <?php echo (!empty($inlinestyles)) ? 'checked="checked"' : ''; ?> type="checkbox" name="inlinestyles" value="1" id="inlinestyles" /> <?php _e('Yes, convert CSS to inline styles automatically', 'wp-mailinglist'); ?></label>
