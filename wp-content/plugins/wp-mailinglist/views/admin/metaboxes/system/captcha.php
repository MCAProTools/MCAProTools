		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>				
						<div class="wp-picker-container">
							<a tabindex="0" id="captcha_bg_button" class="wp-color-result" style="background-color:<?php echo $this -> get_option('captcha_bg'); ?>; ?>;" title="<?php _e('Select Color', 'wp-mailinglist'); ?>"></a>
						...
						jQuery(document).ready(function() {
							...
							jQuery('#captcha_bg_button').click(function(event) {							
								jQuery(this).attr('title', "<?php _e('Current Color', 'wp-mailinglist'); ?>");
							...
							jQuery('html').click(function() {
								...
								jQuery('#captcha_bg_button').attr('title', "<?php _e('Select Color', 'wp-mailinglist'); ?>");
							});
						});
						</script>
				...
				<tr>
					...
					<td>
						<div class="wp-picker-container">
							<a tabindex="0" id="captcha_fg_button" class="wp-color-result" style="background-color:<?php echo $this -> get_option('captcha_fg'); ?>; ?>;" title="<?php _e('Select Color', 'wp-mailinglist'); ?>"></a>
							<span class="wp-picker-input-wrap">
						...
						jQuery(document).ready(function() {
							...
							jQuery('html').click(function() {
								...
								jQuery('#captcha_fg_button').attr('title', "<?php _e('Select Color', 'wp-mailinglist'); ?>");
							});
						});
						</script>
