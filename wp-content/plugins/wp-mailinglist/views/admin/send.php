...
<div class="wrap <?php echo $this -> pre; ?> <?php echo $this -> sections -> send; ?> newsletters">
	<?php if (!empty($_GET['id'])) : ?>
		<h2><?php _e('Edit Newsletter', 'wp-mailinglist'); ?> <a href="?page=<?php echo $this -> sections -> send; ?>" class="add-new-h2"><?php _e('Add New', 'wp-mailinglist'); ?></a></h2>
	<?php else : ?>
		<h2><?php _e('Create Newsletter', 'wp-mailinglist'); ?></h2>
	<?php endif; ?>
...
<?php $history_id = (empty($_POST['ishistory'])) ? esc_html($_GET['id']) : $_POST['ishistory']; ?>
