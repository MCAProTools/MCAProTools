...
<div class="wp-filter">
	<ul class="filter-links">
		...
		<li><a class="<?php echo ($_GET['page'] == $this -> sections -> settings_templates) ? 'current' : ''; ?>" href="?page=<?php echo $this -> sections -> settings_templates; ?>"><i class="fa fa-envelope-o"></i> <?php _e('System Emails', 'wp-mailinglist'); ?></a></li>
