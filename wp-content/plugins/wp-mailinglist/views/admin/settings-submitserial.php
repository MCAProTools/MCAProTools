<div class="wrap newsletters">
	<h2><?php _e('Submit Serial Key', 'wp-mailinglist'); ?></h2>
	
	<p>
		<?php _e('Please submit a serial key in the form below.', 'wp-mailinglist'); ?><br/>
	...
	<form action="?page=<?php echo $this -> sections -> submitserial; ?>" method="post">
		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="serial"><?php _e('Serial Key', 'wp-mailinglist'); ?></label></th>
					<td>
