...
.fp1-subtitle {
  ...
  color: #fff;
    ...
    <div class="content-fp1-box">
        ...
        <p class="fp1-subtitle"><u>Watch Video Below</u></p>

        </center>

        <div class="video-container">
          <iframe src="https://player.vimeo.com/video/224739631?title=0&byline=0&portrait=0" width="720" height="405" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>


          <p class="fp1-buy-button">
