...
.fp3-subtitle {
  ...
  color: #fff;
    ...
    <div class="content-fp3-box">
        ...
        <p class="fp3-subtitle"><u>Watch Video Below</u></p>

        </center>

        <div class="video-container">
          <iframe src="https://player.vimeo.com/video/236256886?title=0&byline=0&portrait=0" width="720" height="405" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>


          <p class="fp3-buy-button">
