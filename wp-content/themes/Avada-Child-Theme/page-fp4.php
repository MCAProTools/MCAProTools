...
<?php
    ...
    <div class="content-fp4-box">
        ...
        <p class="fp4-subtitle"><u>Watch Video Below</u></p>

        </center>

        <div class="video-container">
          <iframe src="https://player.vimeo.com/video/236255301" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>


          <p class="fp4-buy-button">
