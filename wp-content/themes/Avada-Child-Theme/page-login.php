        ...
        if (have_posts()): the_post();
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <?php if (!post_password_required($post->ID)): // 1 ?>
                    ...
                    if (!$smof_data['featured_images_pages']): // 2
                        ?>
                        <?php
                                ...
                                <ul class="slides">
                                    ...
                                    <?php if (has_post_thumbnail() && get_post_meta($post->ID, 'pyre_show_first_featured_image', true) != 'yes'): ?>
                                        ...
                                        <li>
                                            <a href="<?php echo $full_image[0]; ?>" rel="prettyPhoto[gallery<?php the_ID(); ?>]"
                                               title="<?php echo get_post_field('post_excerpt', get_post_thumbnail_id()); ?>"><img
                                    ...
                                    while ($i <= $smof_data['posts_slideshow_number']):
                                        ...
                                        if ($attachment_new_id):
                                            ...
                                            <li>
                                                <a href="<?php echo $full_image[0]; ?>" rel="prettyPhoto[gallery<?php the_ID(); ?>]"
                                                   title="<?php echo get_post_field('post_excerpt', $attachment_new_id); ?>"><img
                                                        src="<?php echo $attachment_image[0]; ?>"
                                                        alt="<?php echo get_post_meta($attachment_new_id, '_wp_attachment_image_alt', true); ?>"/></a>
                                            </li>
                                        <?php endif;
                                        $i++; endwhile; ?>
                                </ul>
                ...
                <div class="post-content">
                    <div class="mca-login-form test">
                        <div class="userpro-head">
                            <div class="userpro-left">Login</div>

                            <div class="userpro-right"><a href="/wp-login.php?action=lostpassword" data-template="reset">Forgot your password?</a>
                            </div>
						...
						if($login === "failed"||$login === "empty"||$login === "false"){
							$errclass="errlogin";
						}
						?>
						<a class="register-button-link <?php echo $errclass;?>" href="https://www.mcaprotools.com/whatismca/">Register</a>
						<?php
                        if ( $login === "failed" ) {
