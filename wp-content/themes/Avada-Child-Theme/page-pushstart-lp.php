...
$mcapushct4= get_user_meta( $user_id, videosaleslandingpage2, true );
?>
  ...
  .video-container {
    ...
    <?php if(have_posts()): the_post();?>
        ...
        <div class="content-lp1-box">
          <center>
            <p class="landing-page-title"><span style="color: red !important;">This “Push Button” System</span> Is Showing Regular People Like You How To Generate $80 - $2000 In Commissions – Every Week!</p>
