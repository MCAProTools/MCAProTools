...
<?php if( $smof_data['header_sticky_bg_color']['opacity'] || $smof_data['header_sticky_bg_color']['opacity'] === '0' ): ?>
...
<?php
if(!$custom_font && $smof_data['google_nav'] != 'None') {
...
<?php endif; ?>
<?php
if(!$custom_font && $smof_data['google_headings'] != 'None') {
