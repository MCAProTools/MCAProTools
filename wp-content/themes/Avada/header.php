...
if (navigator.geolocation) {
 ...
 <?php }  if( is_page( 'pushstart' ) || is_page( 'takeover' )  ) { ?> 

	<div id="main" style="z-index: 2;" class="cpmain clearfix <?php echo $main_class; ?>" style="<?php echo $main_css; ?>">

<?php } else {?><div id="main" style="" class="clearfix <?php echo $main_class; ?>" style="<?php echo $main_css; ?>">
  <?php } ?>
