            ...
            <div id="post-122" class="post-122 page type-page status-publish hentry">
                ...
                <span class="entry-title"
                      ...
                      style="display: none;">Free Video: Reveals How ‘Kids’ In their twenties are earning $2000 Per WEEK!</span><span class="vcard"
                        ...
                        class="fn"><a href="https://mcaprotools.com.localhost/author/ptadmin/" title="Posts by MCAPT Admin" rel="author">MCAPT
                ...
                <div class="post-content">
                    ...
                    <h2 style="font-size: 50px!important;" class="youre-going-text"><img class="size-full wp-image-958"
                                                                ...
                                                                src="https://mcaprotools.s3-us-west-2.amazonaws.com/wp-content/uploads/2015/02/stop_and_watch21.png"

                                                                alt="stop_and_watch2" width="200" height="65"

                                                                srcset="https://mcaprotools.com/wp-content/uploads/2015/02/stop_and_watch21.png 200w, https://mcaprotools.com/wp-content/uploads/2015/02/stop_and_watch21-100x33.png 100w, https://mcaprotools.com/wp-content/uploads/2015/02/stop_and_watch21-120x39.png 120w"
                    ...
                    <div class="su-row">
                        ...
                        <div style="float: right" class="su-column su-column-size-2-5 mca-2kperweek-desc">
                            ...
                            <div class="su-column-inner su-clearfix">
                                ...
                                <div class="twokp-right-subtitle2">See How You Can Earn Upwards of $2,080 Per Week While You’re on Vacation With Your Family…</div>

                                <div class="twokp-right-subtitle3">Just Enter Your Information In Below So You Can Watch This FREE Video!</div>
                                <form method="post" class="af-form-wrapper" accept-charset="UTF-8" action="httpss://www.aweber.com/scripts/addlead.pl">
                                    <textarea style="display:none;" name="listname">awlist3813448</textarea>
                                    <textarea style="display:none;" name="redirect" id="redirect_ec539077ddfbfd0ed6a1a4e4f7bb8862">https://mcaprotools.com/whatismca/?ref=<?php if (isset($_GET['ref'])) echo $_GET['ref']; ?></textarea>
									<input type="hidden" name="meta_required" value="email">
                                    <input class="input-email twokp-email" name="email" type="text" placeholder="Email Address*">
									<input type="submit" class="twokp-submit" value="send the video">
                                </form>
                            </div>
                        </div>
                    </div>
