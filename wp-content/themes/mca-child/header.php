...
<head>
    ...
    <style type="text/css">
        ...
        ?>
        <?php echo $theme_info->get( 'Name' ) . "_" . $theme_info->get( 'Version' ); ?>
        {
            color: green
        ;
        }
        ...
        html, body {
            background-color: <?php echo $smof_data['content_bg_color']; ?>;
        }
        ...
        ?>
        .header-social, #header, .header-v4 #small-nav, .header-v5 #small-nav, #main {
            padding-left: 0px;
            padding-right: 0px;
        }
        ...
        .avada-row, .page-title-container {
            padding-left: <?php echo $hundredp_padding; ?>;
            padding-right: <?php echo $hundredp_padding; ?>;
        }

        .fullwidth-box .avada-row {
            padding-left: <?php echo $hundredp_padding_int; ?>px;
            padding-right: <?php echo $hundredp_padding_int; ?>px;
        }

        .fullwidth-box .avada-row .fusion-full-width-sep {
            margin-left: -<?php echo $hundredp_padding_int; ?>px;
            margin-right: -<?php echo $hundredp_padding_int; ?>px;
        }
        ...
        html, body {
        <?php if(get_post_meta($c_pageID, 'pyre_page_bg_color', true)): ?> background-color: <?php echo get_post_meta($c_pageID, 'pyre_page_bg_color', true); ?>;
        <?php else: ?> background-color: <?php echo $smof_data['bg_color']; ?>;
        <?php endif; ?>
        }
        ...
        <?php if(get_post_meta($c_pageID, 'pyre_page_bg_color', true)): ?> background-color: <?php echo get_post_meta($c_pageID, 'pyre_page_bg_color', true); ?>;
        <?php else: ?> background-color: <?php echo $smof_data['bg_color']; ?>;
        <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_page_bg', true)): ?> background-image: url(<?php echo get_post_meta($c_pageID, 'pyre_page_bg', true); ?>);
            background-repeat: <?php echo get_post_meta($c_pageID, 'pyre_page_bg_repeat', true); ?>;
        <?php if(get_post_meta($c_pageID, 'pyre_page_bg_full', true) == 'yes'): ?> background-attachment: fixed;
            background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php elseif($smof_data['bg_image']): ?> background-image: url(<?php echo $smof_data['bg_image']; ?>);
            background-repeat: <?php echo $smof_data['bg_repeat']; ?>;
        <?php if($smof_data['bg_full']): ?> background-attachment: fixed;
            background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
        ...
        <?php if($smof_data['bg_full']): ?> background-attachment: fixed;
            ...
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php endif; ?> <?php if($smof_data['bg_pattern_option'] && $smof_data['bg_pattern'] && !(get_post_meta($c_pageID, 'pyre_page_bg_color', true) || get_post_meta($c_pageID, 'pyre_page_bg', true))): ?> background-image: url("<?php echo get_template_directory_uri() . '/images/patterns/' . $smof_data['bg_pattern'] . '.png'; ?>");
            background-repeat: repeat;
        <?php endif; ?>
        }
        ...
        @media only screen and (min-device-width: 768px) and (max-device-width: 1366px) and (orientation: portrait) {
            #nav > ul > li, #sticky-nav > ul > li {
                padding-right: <?php echo $smof_data['mobile_nav_padding']; ?>px;
            }
        }
        ...
        #header, #side-header {
        <?php if($smof_data['header_bg_image']): ?> background-image: url(<?php echo $smof_data['header_bg_image']; ?>);
        <?php if($smof_data['header_bg_repeat'] == 'repeat-y' || $smof_data['header_bg_repeat'] == 'no-repeat'): ?> background-position: center center;
        <?php endif; ?> background-repeat: <?php echo $smof_data['header_bg_repeat']; ?>;
        <?php if($smof_data['header_bg_full']): ?> <?php if( $smof_data['header_position'] == 'Top' ): ?> background-attachment: scroll;
        <?php endif; ?> background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php if($smof_data['header_bg_parallax'] && $smof_data['header_position'] == 'Top') : ?> background-attachment: fixed;
        ...
        <?php elseif( get_post_meta( $c_pageID, 'pyre_header_bg_opacity', true ) != '' && $smof_data['header_bg_color'] ): ?> <?php $header_bg_color_rgb = avada_hex2rgb( $smof_data['header_bg_color']['color'] ); ?> background-color: <?php echo sprintf( 'rgba(%s,%s,%s,%s)', $header_bg_color_rgb[0], $header_bg_color_rgb[1], $header_bg_color_rgb[2], get_post_meta( $c_pageID, 'pyre_header_bg_opacity', true ) ); ?>;
        <?php endif; ?>
        }

        #header, #side-header {
        <?php if(get_post_meta($c_pageID, 'pyre_header_bg', true)): ?> background-image: url(<?php echo get_post_meta($c_pageID, 'pyre_header_bg', true); ?>);
        <?php if(get_post_meta($c_pageID, 'pyre_header_bg_repeat', true) == 'repeat-y' || get_post_meta($c_pageID, 'pyre_header_bg_repeat', true) == 'no-repeat'): ?> background-position: center center;
        <?php endif; ?> background-repeat: <?php echo get_post_meta($c_pageID, 'pyre_header_bg_repeat', true); ?>;
        <?php if(get_post_meta($c_pageID, 'pyre_header_bg_full', true) == 'yes'): ?> <?php if( $smof_data['header_position'] == 'Top' ): ?> background-attachment: fixed;
        <?php endif; ?> background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
        ...
        @media only screen and (min-width: 800px) {
            #small-nav, .header-v4 #small-nav, .header-v5 #small-nav {
                background: none;
            }

            .header-social, #header, .header-v4 #small-nav, .header-v5 #small-nav, .header-v5 #header {
                border: none;
            }
        ...
        <?php if( $site_width_percent ): ?>
            .header-wrapper, .header-filler {
                position: absolute;
                width: <?php echo $smof_data['site_width']; ?>;
                z-index: 10000;
            }

            .header-wrapper #header, .header-wrapper .header-social {
                padding: 0 30px;
            }
        ...
        <?php else: ?>
            .header-wrapper, .header-filler {
                position: absolute;
                width: <?php echo ( $site_width + 60 ); ?>px;
                z-index: 10000;
            }
        ...
        #main {
        <?php if($smof_data['content_bg_image'] && !get_post_meta($c_pageID, 'pyre_wide_page_bg_color', true)): $main_bg_image = true; ?> background-image: url(<?php echo $smof_data['content_bg_image']; ?>);
            background-repeat: <?php echo $smof_data['content_bg_repeat']; ?>;
        <?php if($smof_data['content_bg_full']): ?> background-attachment: fixed;
            background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php endif; ?> <?php if($smof_data['main_top_padding'] && !get_post_meta($c_pageID, 'pyre_main_top_padding', true)): ?> padding-top: <?php echo $smof_data['main_top_padding']; ?>;
        <?php endif; ?> <?php if($smof_data['main_bottom_padding'] && !get_post_meta($c_pageID, 'pyre_main_bottom_padding', true)): ?> padding-bottom: <?php echo $smof_data['main_bottom_padding']; ?>;
        <?php endif; ?>
        }
        ...
        #main {
        <?php if(get_post_meta($c_pageID, 'pyre_wide_page_bg_color', true)): ?> background-color: <?php echo get_post_meta($c_pageID, 'pyre_wide_page_bg_color', true); ?>;
        <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_wide_page_bg', true)): $main_bg_image = true; ?> background-image: url(<?php echo get_post_meta($c_pageID, 'pyre_wide_page_bg', true); ?>);
            background-repeat: <?php echo get_post_meta($c_pageID, 'pyre_wide_page_bg_repeat', true); ?>;
        <?php if(get_post_meta($c_pageID, 'pyre_wide_page_bg_full', true) == 'yes'): ?> background-attachment: fixed;
            background-position: center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_main_top_padding', true)): ?> padding-top: <?php echo get_post_meta($c_pageID, 'pyre_main_top_padding', true); ?>;
        <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_main_bottom_padding', true)): ?> padding-bottom: <?php echo get_post_meta($c_pageID, 'pyre_main_bottom_padding', true); ?>;
        <?php endif; ?>
        ...
        .page-title-container {
        <?php if($smof_data['page_title_bg_full']): ?> -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_page_title_bar_bg_full', true) == 'yes'): ?> -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
        <?php elseif(get_post_meta($c_pageID, 'pyre_page_title_bar_bg_full', true) == 'no'): ?> -webkit-background-size: auto;
            -moz-background-size: auto;
            -o-background-size: auto;
            background-size: auto;
        <?php endif; ?> <?php if($smof_data['page_title_bg_parallax']): ?> background-attachment: fixed;
            background-position: top center;
        <?php endif; ?> <?php if(get_post_meta($c_pageID, 'pyre_page_title_bg_parallax', true) == 'yes'): ?> background-attachment: fixed;
            background-position: top center;
        <?php elseif(get_post_meta($c_pageID, 'pyre_page_title_bg_parallax', true) == 'no'): ?> background-attachment: scroll;
        <?php endif; ?>
        }
        ...
        #post-<?php echo $c_pageID; ?> .post-slideshow {
            max-width: <?php echo get_post_meta($c_pageID, 'pyre_fimg_width', true); ?>;
        }
        ...
        <?php endif; ?>
        #post-<?php echo $c_pageID; ?> .post-slideshow img {
            max-width: <?php echo get_post_meta($c_pageID, 'pyre_fimg_width', true); ?>;
        }

        <?php if(get_post_meta($c_pageID, 'pyre_fimg_width', true) == 'auto'): ?>
        #post-<?php echo $c_pageID; ?> .post-slideshow img {
            width: <?php echo get_post_meta($c_pageID, 'pyre_fimg_width', true); ?>;
        }
        ...
        #post-<?php echo $c_pageID; ?> .post-slideshow, #post-<?php echo $c_pageID; ?> .post-slideshow img {
            max-height: <?php echo get_post_meta($c_pageID, 'pyre_fimg_height', true); ?>;
        }

        #post-<?php echo $c_pageID; ?> .post-slideshow .slides {
            max-height: 100%;
        }
        ...
        .woocommerce-invalid:after {
            content: '<?php echo __('Please enter correct details for this required field.', 'Avada'); ?>';
        ...
        #slidingbar-area .avada-row {
            max-width: <?php echo (int) $smof_data['site_width'] + $smof_data['side_header_width']; ?>px;
        }
        ...
        .avada-google-map {
            ...
            margin: 0 auto;
        <?php if($smof_data['gmap_width'] != '100%'): ?> <?php if($smof_data['gmap_topmargin']): ?> margin-top: <?php echo $smof_data['gmap_topmargin']; ?>;
        <?php else: ?> margin-top: 55px;
        <?php endif; ?> <?php endif; ?> <?php if($smof_data['gmap_height']): ?> height: <?php echo $smof_data['gmap_height']; ?>;
        <?php else: ?> height: 415px;
        <?php endif; ?>
        }
...
<div id="boxed-wrapper">
    ...
    <div id="wrapper" class="<?php echo $wrapper_class; ?>">
        ...
        if (is_page('pushstart') || is_page('takeover')) { ?>


            <section id="wrapper" style="z-index:1; position: absolute !important;">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            if (city != '')
                                user_location = city;
                            if (region != '')
                                user_location = user_location == '' ? region : user_location + ',' + region;
                            if (country != '')
                                user_location = user_location == '' ? country : user_location + ',' + country;


                            $('#main').css('background', 'url("https://maps.googleapis.com/maps/api/staticmap?center=' + user_location + '&size=640x640") no-repeat');
                            // alert('test');
                            console.log('"https://maps.googleapis.com/maps/api/staticmap?center=' + user_location + '&size=640x640"');


                        });
                    </script>
                    <!-- window.location.href="mcaprotools-invite/?ref= -->
                <?php }
        ...
        <?php } ?>
        <div id="main" style="" class="clearfix <?php echo $main_class; ?>" style="<?php echo $main_css; ?>">
            <div class="avada-row" style="<?php echo $row_css; ?>">
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        $('.redirect-invite').click(function () {
                            window.location.href = "mcaprotools-invite/?ref=<?php echo do_shortcode("[protool_mca_user meta_key='referrer' referrer_key='ref' display_type='single_line']"); ?>"
                        });
                    });
                </script>