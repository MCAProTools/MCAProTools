	...
	<div id="content" style="<?php echo $content_css; ?>">
		...
		?>
                    ...
                    <div id="landing-box-salesvideo" style="width: 840px; padding: 50px; background-color: #fff; margin: 0 auto;" class="6fig-box">
                            ...
                            <p class="6fig-subtitle" style="margin: 0 auto; width: 85% !important; font-size: 22px; padding: 25px; text-align: center; padding-top: 0px;"><u>Watch My Video Below To Discover How You Can Too...</u></p>
